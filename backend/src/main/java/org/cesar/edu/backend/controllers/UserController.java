...
public class UserController {
    ...
    public ResponseEntity<?> pegarProfessor(@PathVariable String cpf) {
        try {
            ...
            UserResponse response = UserResponse.fromProfessor(professor);

            return ResponseEntity.ok(response);

        } catch (Exception e) {
            return ResponseEntity.status(500).body("Erro interno ao buscar professor: " + e.getMessage());
        }
    }
    @PutMapping("/professor/{cpf}")
    public ResponseEntity<?> atualizarProfessor(@RequestBody UserCreateRequest dto, @PathVariable String cpf) {
    ...
    public ResponseEntity<?> atualizarAluno(@PathVariable String cpf, @RequestBody UserCreateRequest dto) {
    ...
    public ResponseEntity<?> deletarAluno(@PathVariable String cpf) {
